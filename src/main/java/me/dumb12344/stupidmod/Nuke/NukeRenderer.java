...
public class NukeRenderer extends EntityRenderer<PrimedNuke> {
    ...
    public void render(PrimedNuke p_116177_, float p_116178_, float p_116179_, PoseStack p_116180_, @NotNull MultiBufferSource p_116181_, int p_116182_) {
        p_116180_.pushPose();
        ...
        p_116180_.mulPose(Axis.YP.rotationDegrees(90.0F));
        TntMinecartRenderer.renderWhiteSolidBlock(this.blockRenderer, NukeRegistry.NUKE.get().defaultBlockState(), p_116180_, p_116181_, p_116182_, i / 5 % 2 == 0);
        p_116180_.popPose();
        super.render(p_116177_, p_116178_, p_116179_, p_116180_, p_116181_, p_116182_);
    }

    public @NotNull ResourceLocation getTextureLocation(@NotNull PrimedNuke p_116175_) {
