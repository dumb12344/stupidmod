...
public class FuniSoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> FUNISOUND = SOUND_EVENTS.register("sounds_damage", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Stupidmod.MODID,"sounds_damage")));
}
