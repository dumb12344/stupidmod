...
public class C4Entity2 extends Entity implements TraceableEntity {
    @Nullable
    private LivingEntity owner;

    public C4Entity2(EntityType<? extends C4Entity2> p_32076_, Level p_32077_) {
        super(p_32076_, p_32077_);
        this.blocksBuilding = false;
    }

    public C4Entity2(Level p_32079_, double p_32080_, double p_32081_, double p_32082_, @Nullable LivingEntity owner) {
    ...
    protected void onHit(HitResult p_37260_){
        //this.getOwner().sendSystemMessage(Component.literal("test"));
